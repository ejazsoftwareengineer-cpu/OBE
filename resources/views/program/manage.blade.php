                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <?php if($write_permission === true || $check_all_permission === true) {?> 
                                ...
                                <a href="{{ route('addprogram') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add Program</a>
<?php } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="program-datatable" class="yajra-datatable table table-stripped mb-0">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <!-- <th class="text-right">Institute</th> -->
                                                <!-- <th class="text-right">Description</th> -->
                                                <th class="text-right">NO. of Session</th>
        ...
        <script>
                $(document).ready(function(){
                    ...
                    var table = $('.yajra-datatable').DataTable({
                        processing: true,
                        serverSide: true,
                        ajax: "{{ route('getprograms') }}",
                        columns: [
                            {data: 'name', name: 'name'},
                            // {data: 'institute', name: 'institute'},
                            // {data: 'description', name: 'description'},
                            {data: 'no_of_session', name: 'no_of_session'},
