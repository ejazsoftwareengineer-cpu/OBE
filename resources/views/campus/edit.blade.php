						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<form method="POST" action="{{ route('updatecampus') }}" class="mb-5" id="validationForm" name="validationForm">
										@csrf
										...
										<div class="row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="name" type="text" class="form-control"
															name="name" value="{{ $campus->name }}"   autofocus placeholder="Enter campus name">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select name="status" class="select">
															...
															<option value="0" @if($campus->status == '0') selected @endif>Inactive</option>
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="city" type="text" class="form-control"
															name="city" value="{{  $campus->city }}"   autofocus placeholder="Enter city">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="zipcode" type="text" class="form-control"
															name="zipcode" value="{{ $campus->zipcode }}"   autofocus placeholder="Enter zipCode">
													</div>
												</div>
											</div>
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="campus_code" type="text" class="form-control"
															name="campus_code" value="{{ $campus->campus_code }}"   autofocus placeholder="Enter campus code">
													...
													<div class="col-lg-9">
														<select name="organization_id" class="select">
                                                            ...
                                                            @foreach ($organizations as $organization)
																<option value="{{ $organization->id }}" @if($campus->organization_id === $organization->id) ? selected : '' @endif >{{ $organization->name }}</option>
															@endforeach
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea type="text" name="location"  class="form-control" placeholder="Enter campus location">{{ $campus->location }}</textarea>
