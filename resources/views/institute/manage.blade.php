                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                            <?php if($write_permission === true || $check_all_permission === true) {?> 
                                ...
                                <a href="{{ route('addinstitute') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add Institute</a>
<?php } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="institute-datatable" class="yajra-datatable table table-stripped mb-0">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
