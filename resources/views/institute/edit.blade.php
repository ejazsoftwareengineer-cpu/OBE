					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form method="POST" action="{{ route('updateinstitute') }}" class="mb-5" id="validationForm" name="validationForm">
										@csrf
										...
										<div class="row">
                                            <div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="name" type="text" class="form-control"
															name="name" value="{{ $institute->name }}" placeholder="Enter institute name">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea type="text" name="vision" class="form-control" placeholder="Enter vision"> {{ $institute->vision }}</textarea>
											...
											<div class="col-xl-6">
													...
													<div class="col-lg-9">
														<select name="campus_id" class="select">
															...
															@foreach ($campuses as $campus)
																<option value="{{ $campus->id }}" @if($campus->id === $institute->campus_id) ? selected : '' @endif  >{{ $campus->name }}</option>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea type="text" name="mission" class="form-control" placeholder="Enter mission">{{ $institute->mission }}</textarea>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
													<textarea type="text" name="description" value="{{ old('description') }}"  class="form-control" placeholder="Enter description">{{ $institute->description }}</textarea>
													</div>
												</div>
