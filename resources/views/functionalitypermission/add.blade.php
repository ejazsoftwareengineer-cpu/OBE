...
<html lang="en">
    <head>
        ...
        <title>Add Functionality Permission</title>      
                ...
                <div class="content container-fluid">
						...
						<div class="row">
							<div class="col">
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Add Functionality Permission</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<form method="POST" action="{{ route('storefunctionalitypermission') }}" class="mb-5" id="validationForm" name="validationForm">
										@csrf
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select id="user_id" name="user_id" class="select" onchange="getUserRole('{{route('getrolesbyuser')}}')">
													...
													<div class="col-lg-9">
														<select id="function_id" name="function_id" class="select" onchange="getTableData('{{route('getdatabyfunction')}}')">
															...
															@foreach ($functionality as $fun)
																<option value="{{ $fun->id }}" >{{ $fun->functionality_name }}</option>
															@endforeach
														</select>
		...
		<script>
			...
			function getUserRole(siteurl){
				const user_id = $('#user_id').val();
				// alert(function_id);
				$('#role_id').html('');
				getDropDownRoles(siteurl, user_id);
			}
			function getDropDownRoles(siteurl, id){
				jQuery.ajaxSetup({
					headers: {
