                                ...
                                <div class="profile-view">
                                    <div class="profile-img-wrap">
                                        <div class="profile-img">
                                            <a href="#"><img alt="" src="{{ 'public/assets/img/profiles/avatar-02.jpg'}}"></a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="profile-info-left">
                                                    <h3 class="user-name m-t-0 mb-0">{{ $user_detail->name }}</h3>
                                                    <h6 class="text-muted">{{ $user_detail->phone_number ? $user_detail->phone_number : '-' }}</h6>
                                                    <small class="text-muted">{{ $user_detail->email ? $user_detail->email : '-'  }}</small>
                                            ...
                                            <div class="col-md-7">
                                                <ul class="personal-info">
                                                    <li>
                                                        ...
                                                        <div class="text"><a href="">{{ $user_detail->phone_number ? $user_detail->phone_number : '-' }}</a></div>
                                                    </li>
                                                    <li>
                                                        <div class="title">Email:</div>
                                                        <div class="text"><a href="">{{ $user_detail->email ? $user_detail->email : '-' }}</a></div>
                                                    </li>
                                                    <li>
                                                        <div class="title">Address:</div>
                                                        <div class="text">{{ $user_detail->address ? $user_detail->address : '-' }}</div>
                                                    </li>
                                                    <li>
                                                        <div class="title">Gender:</div>
                                                        <div class="text">{{ $user_detail->gender ? $user_detail->gender : '-' }}</div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="card profile-box flex-fill">
                                    <div class="card-body">
                                        ...
                                        <ul class="personal-info">
                                            <li>
                                                <div class="title">Email</div>
                                                <div class="text">{{ $user_detail->email ? $user_detail->email : '-' }}</div>
                                            </li>
                                            <!-- <li>
