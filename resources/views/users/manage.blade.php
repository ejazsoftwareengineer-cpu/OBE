                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto float-right ml-auto">
                          <?php if($write_permission === true || $check_all_permission === true) {?> 
                            ...
                            <a href="{{ route('adduser') }}" class="btn add-btn"><i class="fa fa-plus"></i> Add User</a>
<?php } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table id="users-datatable" class="yajra-datatable table table-stripped mb-0">
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Institute</th>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="modal-btn delete-action">
                                <div class="row">
                                    <div class="col-6">
                                        <a href="javascript:void(0);" onclick="deleteData('{{ route('destroyuser') }}')" class="btn btn-primary continue-btn">Delete</a>
                                    </div>
                                    <div class="col-6">
