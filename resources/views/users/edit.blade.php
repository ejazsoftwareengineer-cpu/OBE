						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<form method="POST" action="{{ route('updateuser') }}" class="mb-5" id="validationForm" name="validationForm">
										@csrf
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="firstname" type="text" class="form-control"
															name="firstname" value="{{ $user->firstname }}" autofocus placeholder="Enter first name">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="lastname" type="text" class="form-control" name="lastname" autofocus value="{{ $user->lastname }}" placeholder="Enter last name">
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="phone_number" type="text" class="form-control"
															name="phone_number" value="{{ $user->phone_number }}" autofocus placeholder="Enter phone number">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="email" type="text" class="form-control"
															name="email" value="{{ $user->email }}" autofocus placeholder="Enter email address">
													...
													<div class="col-lg-9">
														<select name="institute_id" class="select">
															...
															@foreach ($institute as $ins)
																<option value="{{ $ins->id }}" @if($ins->id == $user->institute_id) selected @endif>{{ $ins->name }}</option>
															@endforeach
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<textarea type="text" name="address" class="form-control" placeholder="Enter address">{{ $user->address }}</textarea>
													</div>
												</div>
											</div>
										</div>
