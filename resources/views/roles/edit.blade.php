						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<form method="POST" action="{{ route('updaterole') }}" class="mb-5" id="validationForm" name="validationForm">
										@csrf
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="name" type="text"  onblur="creat_link()" class="form-control"
															name="name" value="{{ $role->name }}" placeholder="Enter Role Name">
										...
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="permalink" type="text" value="{{ $role->guard_name }}" class="form-control"
															name="slug" readonly>
													</div>
												</div>
											</div>
