									...
									<form method="POST" action="{{ route('storestudent') }}" class="mb-5" id="validationForm" name="validationForm" enctype="multipart/form-data">
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<!-- <div class="form-group row">
													<label class="col-lg-3 col-form-label">Roll No. <span class="text-danger">*</span></label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input id="registration_no" type="text" class="form-control"
															name="registration_no" value="{{ old('registration_no') }}"   autofocus placeholder="Enter Sap ID">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<span class="text-danger" id="span_cnic">{{$errors->first('cnic')}}</span>
