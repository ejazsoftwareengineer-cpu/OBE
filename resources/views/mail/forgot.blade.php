...
<div>
    ...
    <div style="background-color:#f4f4f4;width:800px !important;margin: auto auto auto auto; height: 300px;">
        ...
        <div style="padding: 15px 30px 30px 30px;">
            <h1 style="color:#363636">Welcome to Outcome Based Education</h1>
            <p style="margin-bottom: 10px;color:#363636">Your new login credentials are provided below. Click Continue to sign in and access your account.</p>
